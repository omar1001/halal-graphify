...
Concept 1 ("The Path Lights Up"): a terminal types `halal-graphify path ...` on the
...
e(f'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 {W} {H}" width="{W}" height="{H}" '
  ...
  f'aria-label="halal-graphify path query lighting up a knowledge graph">')
e('<defs>')
...
e(f'<text x="{PANEL-16}" y="34" text-anchor="end" font-size="10" fill="{TXT_DIM}">halal-graphify</text>')
...
cmd = 'halal-graphify path "FastAPI" "ModelField"'
