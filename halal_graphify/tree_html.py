...
CLI: ``halal-graphify tree [--graph PATH] [--output HTML] [--root PATH]
    ...
    *,
    ...
    for src_file, syms in sorted(by_file.items()):
        ...
        for n in syms:
            ...
            # Skip the redundant file-name node halal-graphify emits (bare basename or
...
def write_tree_html(
    ...
    *,
    ...
    title = f"{tree['name']} — halal-graphify tree viewer"
