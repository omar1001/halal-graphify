"""html — moved verbatim from halal_graphify/export.py."""
...
// (halal-graphify add) can contain a double-quote; dropping the stringified id
...
<head>
<meta charset="UTF-8">
<title>halal-graphify - {title}</title>
