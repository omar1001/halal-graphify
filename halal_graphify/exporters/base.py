"""Shared constants/helpers for the halal-graphify exporters package.

Symbols used by more than one exporter live here so each exporter module can be
split out of halal_graphify/export.py without a circular import (export.py and the
...
# Obsidian exporters. Moved verbatim from halal_graphify/export.py.
COMMUNITY_COLORS = [
