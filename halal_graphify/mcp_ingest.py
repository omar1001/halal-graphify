...
halal-graphify with `--mcp` can now query its own configured MCP layer.
...
# only halal_graphify.ids), so this can no longer drift from extract._file_stem.
from halal_graphify.extractors.base import _file_stem  # noqa: E402
