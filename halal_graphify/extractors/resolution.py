"""resolution — moved verbatim from halal_graphify/extract.py."""
...
def _merge_decl_def_classes(
    ...
    nodes — which then trips every resolver's single-definition hub-node guard
    ...
    HUB-NODE GUARDS (false merges are the main risk):
...
def _pascal_resolve_unit(from_path: Path, unit_name: str) -> str:
    """Resolve a Pascal unit name to the halal-graphify node ID of its source file.
