"""objc — moved verbatim from halal_graphify/extract.py."""
from __future__ import annotations

from halal_graphify.extractors.base import _file_stem, _make_id, _read_text
from halal_graphify.extractors.engine import _cpp_declarator_name, _semantic_reference_edge
from halal_graphify.extractors.resolution import _resolve_c_include_path
...
def extract_objc(path: Path) -> dict:
    ...
    def walk(node, parent_nid: str | None = None) -> None:
        ...
        if t == "class_interface":
            ...
            # single-definition hub-node guard — destroying edges the same corpus
