...
from halal_graphify.callflow_html import derive_sections_from_communities, write_callflow_html
...
def test_derive_sections_groups_by_architecture_keywords():
    nodes = [
        {"id": "extract_py", "label": "extract_python", "source_file": "halal_graphify/extract.py", "community": 0},
        {"id": "extract_js", "label": "extract_js", "source_file": "halal_graphify/extract.py", "community": 0},
        {"id": "to_html", "label": "to_html", "source_file": "halal_graphify/export.py", "community": 1},
...
def test_load_graph_rejects_oversized_file(monkeypatch, tmp_path):
    ...
    import pytest
    from halal_graphify.callflow_html import load_graph
...
def test_load_graph_preserves_edge_direction(tmp_path):
    ...
    from halal_graphify.callflow_html import generate_call_table_rows, load_graph
...
def test_call_table_counts_indirect_call_relation():
    ...
    from halal_graphify.callflow_html import generate_call_table_rows
