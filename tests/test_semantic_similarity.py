...
from halal_graphify.analyze import surprising_connections, _surprise_score
...
def _make_report_with_semantic_surprise():
    ...
    return generate(G, communities, cohesion, labels, hubs, surprises, detection, tokens, "./project")
