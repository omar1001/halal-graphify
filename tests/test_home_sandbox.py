...
from halal_graphify.__main__ import claude_uninstall
...
def test_global_uninstall_is_captured_by_sandbox(tmp_path, tmp_path_factory):
    ...
    """
    skill = Path.home() / ".claude" / "skills" / "halal-graphify" / "SKILL.md"
    skill.parent.mkdir(parents=True)
    skill.write_text("# halal-graphify skill (sandbox copy)\n", encoding="utf-8")
