"""Tests for halal_graphify.mcp_ingest — MCP config file extraction."""
...
from halal_graphify.mcp_ingest import (
...
def test_dispatch_does_not_reroute_generic_json(tmp_path):
    from halal_graphify.extract import _get_extractor, extract_json
