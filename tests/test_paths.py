"""Tests for halal_graphify.paths — the shared test-path classifier (#1553)."""

from __future__ import annotations

import pytest

from halal_graphify.paths import (
    _is_test_path,
...
def test_is_absolute_any_platform_accepts_both_conventions(path):
    from halal_graphify.paths import is_absolute_any_platform
