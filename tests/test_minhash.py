"""Tests for halal_graphify/_minhash.py — MinHash sketch and band-LSH."""
from __future__ import annotations
import numpy as np
import pytest
from halal_graphify._minhash import MinHash, MinHashLSH, _optimal_lsh_params
...
def test_dedup_import_does_not_pull_scipy_or_numpy_testing():
    ...
    import halal_graphify.dedup  # noqa: F401
