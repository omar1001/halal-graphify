...
def test_pascal_no_error():
    from halal_graphify.extract import extract_pascal
...
def test_lfm_no_error():
    from halal_graphify.extract import extract_lazarus_form
...
def test_lpk_no_error():
    from halal_graphify.extract import extract_lazarus_package
...
def test_dfm_no_error():
    from halal_graphify.extract import extract_delphi_form
...
def test_pascal_no_duplicate_method_edges_tree_sitter():
    ...
    breaking the cross-file inherited-call resolver's hub-node guard). Edges are
...
def test_pascal_no_duplicate_method_edges_regex():
    from halal_graphify.extract import _extract_pascal_regex
