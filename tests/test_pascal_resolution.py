...
file's own scope. halal_graphify.pascal_resolution closes that gap as a
...
from halal_graphify.extract import extract, extract_pascal
...
def test_pascal_resolver_registered():
    from halal_graphify.resolver_registry import registered_resolvers
