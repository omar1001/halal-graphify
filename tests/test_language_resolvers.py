"""Tests for the language resolver registry (halal_graphify.resolver_registry).
...
from halal_graphify.resolver_registry import (
    LanguageResolver,
...
def test_default_registry_contains_swift_then_python() -> None:
    ...
    import halal_graphify.extract  # noqa: F401  (registers resolvers on import)
