"""Integration tests for halal-graphify export subcommands and CLI commands.
...
# ── halal-graphify export obsidian ─────────────────────────────────────────────────
...
# ── halal-graphify export neo4j (cypher) ───────────────────────────────────────────
...
# ── halal-graphify export falkordb (cypher) ────────────────────────────────────────
...
def test_extract_writes_to_graphify_out_env(tmp_path):
    """#1423: `halal-graphify extract` honours GRAPHIFY_OUT for where it WRITES, not only
...
# ── halal-graphify path direction (#2487) ─────────────────────────────────────────
...
# ── halal-graphify export unknown format ───────────────────────────────────────────
...
# it does NOT regenerate .graphify_analysis.json. The full `halal-graphify extract`
...
# Without these tests, `halal-graphify export html|obsidian|wiki|svg|graphml|neo4j`
...
# ── halal-graphify query names its graph (#2789) ───────────────────────────────────
