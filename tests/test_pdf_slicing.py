...
Papers are the longest documents anyone points halal-graphify at, and a compressed
...
from halal_graphify.llm import _FILE_CHAR_CAP, _file_to_text, _read_files

try:  # the reader this fix introduces
    from halal_graphify.file_slice import unit_source_text
