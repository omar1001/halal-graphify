"""Tests for hyperedge support in halal-graphify."""
...
from halal_graphify.export import attach_hyperedges, to_json
...
def _make_report(G):
    ...
    cohesion = {0: 1.0}
    labels = {0: "All"}
    hubs = [{"label": "BasicAuth", "degree": 2}]
    surprises = []
    return generate(G, communities, cohesion, labels, hubs, surprises, SAMPLE_DETECTION, {"input": 10, "output": 5}, ".")
