...
def test_legacy_node_name_path_aliases_folded():
    ...
    from halal_graphify.validate import validate_extraction
...
def test_build_from_json_ambiguous_old_stem_alias_stays_dangling(tmp_path):
    ...
    extraction = {
        "nodes": [
            ...
            # form, matching what a real halal-graphify update run would already have
...
def test_merge_raw_extraction_tier_scoped(tmp_path):
    ...
    from halal_graphify.build import merge_raw_extraction
