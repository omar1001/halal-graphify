...
`halal-graphify install --platform X` must only advance `.graphify_version` for the
...
halal-graphify A, package is B" staleness warning was suppressed even though the
...
# A prior halal-graphify version stamped into an unrelated, not-reinstalled platform.
