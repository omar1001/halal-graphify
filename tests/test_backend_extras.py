...
Friction this guards: `uv tool install halal-graphify` puts halal-graphify in an isolated
...
from halal_graphify.llm import _backend_pkg_hint
...
def test_backend_pkg_hint_points_at_uv_tool_and_extra():
    ...
    assert 'halal-graphify[anthropic]' in msg
