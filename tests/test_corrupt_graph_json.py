...
affected.load_graph (`halal-graphify prs`), and diagnostics._read_json_file
(`halal-graphify diagnose`). A truncated / invalid file (incomplete write, power loss,
...
from halal_graphify.diagnostics import _read_json_file
