...
from halal_graphify.affected import affected_nodes
from halal_graphify.extract import extract, extract_python
...
def test_cross_file_indirect_survives_id_relativization(tmp_path):
    ...
    root, as the `halal-graphify extract` CLI passes), the id-remap rewrites node ids
