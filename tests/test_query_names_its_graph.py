...
`graphify-out/` resolves against the CWD. Running `halal-graphify query` from a parent
...
from halal_graphify.serve import _display_graph_path, _query_graph_text
