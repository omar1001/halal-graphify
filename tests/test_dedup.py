...
import pytest
from halal_graphify.dedup import (
...
def test_dedup_still_merges_real_typos():
    ...
    from halal_graphify.dedup import _is_variant_pair, _short_label_blocked
...
def test_variant_pair_helper():
    ...
    from halal_graphify.dedup import _is_variant_pair
...
def test_prefix_guard_does_not_block_same_length_typos():
    ...
    from halal_graphify.dedup import _norm
...
def test_numeric_tokens_differ_helper():
    ...
    multisets (#1284)."""
    from halal_graphify.dedup import _numeric_tokens_differ
...
def test_content_token_swap_helper():
    ...
    from halal_graphify.dedup import _content_token_swap
...
def test_same_word_variant_helper():
    ...
    from halal_graphify.dedup import _same_word_variant
