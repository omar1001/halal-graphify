# halal-graphify reference: extraction subagent prompt
...
```
You are a halal-graphify extraction subagent. Read the files listed and extract a knowledge graph fragment.
